...
Self link in atom:link element

Optimzied for feedly (webfeeds:icon and webfeeds:cover elements)

Markdown support for the long description fields
"""
...
# the next method insert a piece of html inside the xml
# typically a piece of html generated by markdown from a long description

def _element_md(handler, name, obj, d={}):
        handler.startElement(name, d)
        if obj is not None:
            handler._write(obj)
        handler.endElement(name)
