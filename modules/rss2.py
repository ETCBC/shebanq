"""
ShebanqRSS - A Python library for generating RSS 2.0 feeds.

Modified version of PyRSS2Gen 1.1.0 by "Andrew Dalke <dalke@dalkescientific.com>",
as found in the web2py distribution 2.13.3.

Modified by "Dirk Roorda <shebanq@ancient-data.org>" February 2016.
"""

__version__ = (1, 0, 0)
__author__ = "Dirk Roorda <shebanq@ancient-data.org>"

_generator_name = 'ShebanqRSS' + "-" + ".".join(map(str, __version__))
