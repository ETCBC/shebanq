...
class SELECT_OR_ADD_OPTION(object):  # and even EDIT
    ...
    def widget(self, field, value):
        ...
        for action in actions:
            ...
            form_loader_div = DIV(LOAD(c=self.controller, f=self.function, args=extra_args, ajax=True, ajax_trap=True), _id=my_select_id + "_" + action + "_dialog-form", _title=action + ": " + self.referenced_table)
