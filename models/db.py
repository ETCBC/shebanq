...
versions = {
    '4': {
        ...
        'notes': 'Fixed version. The data for this version is a snapshot. The underlying data is in the ETCBC/BHSA Github repo.',
        'present': True,
        'fixed': True,
    },
    '4b': {
    ...
    'c': {
        ...
        'notes': 'Current version. May receive occasional updates. The underlying data is in the ETCBC/BHSA Github repo.',
        'present': True,
        'fixed': False,
    },
}
